...
public class Operator001 {
	...
	public static void main(String[] args) {
		...
		//Q2. 3의 배수?
		//A1. 나머지연산자 - 짝수니? 홀수니?
		// 짝수 : 0(짝) 1(홀) 2(짝) 3(홀) - 2로 나눴을때 나머지가 0이면 짝수
		// 0%2 == 0  0이면 짝수
		// 1%2 == 1  1이면 홀수
		// 2%2 == 0  2이면 짝수
		...
		// 1%3 = 1  나머지 1
		// 2%3 = 2  나머지 2
		// 3%3 = 0  나머지 0      //3의 배수라면 0 / 나머지는 0,1,2
		...
		// a=10 a가 짝수? == 나머지 연산시 0 ==   a%2==0
		System.out.println( a%2 == 0 ); //짝수표현 true
		System.out.println( a%2 == 1 ); //홀수표현 false
		// b=3   b가 3의 배수니? ==3으로 나누면 나머지연산시 0
		System.out.println( b%3 == 0 ); 
		
		
		// 3. 조건( &  &&(조건1, 조건2 모든조건 만족시 ) |   ||(조건1,조건2 여러조건 중 하나) )
